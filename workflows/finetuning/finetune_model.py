...
def main():
    ...
    parser.add_argument(
        "--data_name", type=str, required=True, help='Dataset name (e.g., "Bonev2017_CN")'
    )
    parser.add_argument(
        "--organism",
        type=str,
    ...
    parser.add_argument(
        "--data-split", type=int, required=True, help="Model split index (e.g., 0, 1, 2...)"
    )
    ...
    output_base = (
        f"/scratch1/smaruj/Akita_pytorch_models/finetuned/{args.organism}_models/{args.data_name}"
    )
    save_model_path = (
