...
def transfer_weights(model, h5_file, target_idx, organism):
    ...
    conv_tower_mapping = [
        (1, 1, 2), (2, 5, 6), (3, 9, 10), (4, 13, 14), (5, 17, 18),
    ...
    residual_1d_blocks = [
        (11, model.residual1d_block1), (13, model.residual1d_block2),
        (15, model.residual1d_block3), (17, model.residual1d_block4),
        (19, model.residual1d_block5), (21, model.residual1d_block6),
        (23, model.residual1d_block7), (25, model.residual1d_block8),
        (27, model.residual1d_block9), (29, model.residual1d_block10),
    ...
    residual_2d_blocks = [
        (1, 35, model.residual2d_block1), (3, 37, model.residual2d_block2),
        (5, 39, model.residual2d_block3), (7, 41, model.residual2d_block4),
        (9, 43, model.residual2d_block5), (11, 45, model.residual2d_block6)
    ]
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="Target index to extract from TF model"
    )
    parser.add_argument(
        "--data_split",
        type=int,
        required=True,
        help="Data split/fold index (e.g., 0-7)"
    )
    parser.add_argument(
        "--organism",
        type=str,
